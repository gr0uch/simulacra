...
function rehydrate (scope, obj, def, node, matchNode) {
  ...
  var meta, valueIsArray, activeNodes, index, max, treeWalker, currentNode
  ...
  for (key in def) {
    ...
    while (treeWalker.nextNode() && index < max) {
